        ...
        projects: [
          {
            ...
            desc: `A full category utility application for locating and rating mobile workspaces.
            Built with Node.js w/ Express, Google API, Workfrom API, PostgreSQL, and npm.`
          },
          {
            id: 2,
            name: 'The Flame Paladin Saga — Developer, Animator, Asset Creator',
            desc: `A full category ‘platformer’ game application, complete with score saving,
            and a dynamic leaderboard. Built with Angular 2 w/ TypeScript, Node.js w/ Express,
            PostgreSQL, Knex.js, and npm.`,
          },
        ]
      },
      {
